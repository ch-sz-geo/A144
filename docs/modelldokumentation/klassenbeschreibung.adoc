...
==== Klasse `+Gebiet+`
Eine Spezialisierung der Klasse `+Geometrie+`, welche den Geometrietyp "Fläche" aufweist.
...
==== Klasse `+Pfad+`
Eine Spezialisierung der Klasse `+Geometrie+`, welche den Geometrietyp "Linie" aufweist.
...
==== Klasse `+Ort+`
Eine Spezialisierung der Klasse `+Geometrie+`, welche den Geometrietyp "Punkt" aufweist.
...
==== Klasse `+Dokument+`
Die Klasse ``+Dokument+` führt die Informationen der geologischen Berichte.
