...
==== Klasse `+Status+`
Die Werte für den Status geben an, wie die Erfassung der Bohrlinformationen fortgeschritten ist. Sie dienen der zuständigen Stelle als Hinweis, ob alle Bohrungen eines Dokuments vollständig dokumentiert wurden oder diesbezüglich noch Arbeiten zu tun sind.
...
| öffentlich
m| rStatus
| Fremdschlüssel zum Status (Stammdaten) um anzugeben, ob die im Dokument aufgeführten Bohrprofile vollständig dokumentiert sind.
| todo: Angabe der UUID 
| öffentlich
4+| *Geometrie*
| - - -
| - - -
...
==== Klasse `+Bohrdetail+`
Die Klasse `+Bohrdetail+` verweist auf die Klasse `+Bohrung+` des Datenmodells "Bohrungen" (A244). Ihr kommt die Rolle einer Beziehungstabelle zu, welche zwischen der Klasse `+Dokument+` (dieses Thema) und `+Bohrung+` steht. Die Klasse wird im Thema A144 geführt, um die in einem Dokument aufgeführten Details einer Bohrung anzeigen zu können.
...
| öffentlich
m| Bohrung
| OID des Bohrobjektes aus dem Thema A244 (Klasse `+Bohrung+`).
| 78754757-a6b4-4081-bf9c-e2d2dc4d1133
| öffentlich
4+| *Beziehungsattribute*
m| rGeometrie
| Fremdschlüssel zur Klasse `+Dokument+`.
| 72fc88d1-6c98-415c-9c13-d5eb29f0d826
| öffentlich
4+| *Geometrie*
| - - -
| - - -
