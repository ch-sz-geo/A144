...
:subtitle: geologische Berichte des Untersuchungsbereichs "Umwelt" (A144)
ifdef::backend-pdf[]
= {title}
{subtitle}
...
* https://amandawetter.github.io/A144_Rebuild/[Übersicht A144 Dokumentation] +
* https://amandawetter.github.io/Aa144_Rebuild/docs/modelldokumentation.pdf[Dokumentation als PDF] +
